...
export default function Layout({ children, currentPageName }) {
  ...
  return <div className="app-shell">
    {!hideHeader && <header className="app-header"><div className="app-header-inner">
      <Link to={createPageUrl('Landing')} className="app-brand no-tap-highlight"><div className="app-brand-mark">🍕</div><div className="min-w-0"><div className="app-brand-title">Pizzapolis</div><div className="app-brand-subtitle">Real slice plans</div></div></Link>
